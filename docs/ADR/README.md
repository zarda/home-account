...
| [0106](0106-the-review-step-splits-a-row-and-merges-two.md) | The review step splits a row, and merges two | Accepted; extends 0099 and 0103; excepts 0060; widens 0101; Remove gap closed by 0108; the dead helper it deferred is recorded by 0111 | 2026-09-08 |
...
| [0108](0108-the-review-step-removes-a-row.md) | The review step removes a row | Accepted; extends 0103 and 0106 | 2026-09-10 |
...
| [0111](0111-the-position-overlap-pass-is-removed.md) | The position-overlap pass is removed | Accepted; applies 0048 | 2026-09-10 |
| [0112](0112-pwaservice-keeps-only-the-surface-something-calls.md) | PwaService keeps only the surface something calls | Accepted; applies 0048 and 0105 | 2026-09-10 |
