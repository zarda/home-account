...
| [docs/receipt-import.md](docs/receipt-import.md) | Receipt import: the two entry points, engine routing, language and currency, the offline queue, and what bounds coverage |
